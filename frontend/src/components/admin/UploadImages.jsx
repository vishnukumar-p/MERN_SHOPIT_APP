...
const UploadImages = () => {
    ...
    const [deleteProductImage, {isLoading: isDeleteLoading, error: deleteError,isSuccess: isDeleteSuccess},] = useDeleteProductImageMutation();
    ...
    const handleImagePreviewDelete = (image) => {
        const filters = imagesPreview.filter(img => img !== image);
        setImages(filters);
        setImagesPreview(filters);
    }
    ...
    return (
        <AdminLayout>
            <MetaData title="Upload Product Iamges"/>
